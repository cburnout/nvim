...
M.on_attach = function(client, bufnr)
  ...
  buf_set_keymap('n', '<leader><leader>', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>', opts)
...
local lsp_install_servers = require'lspinstall'.installed_servers()
for _, server in pairs(lsp_install_servers) do
  require'lspconfig'[server].setup{ on_attach = M.on_attach}
end
